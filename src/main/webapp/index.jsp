...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            <h2>Jenkins</h2>
            <p>Jenkins is a free and dsdopen source automation server. Jenkins helps to automate the non-human part of the software development process, with continuous integration and facilitating technical aspects of continuous delivery</p>
            <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
        </div>
        <div class="col-md-4">
            <h2>Maven</h2>
